...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/page/topics-detail/style.css">
  </link>
    ...
    <div class="wrapper">
      ...
      <div class="article">
        <h2 class="article_heading">
          NEWS記事のタイトルです。NEWS記事のタイトルです。NEWS記事のタイトルです。NEWS記事のタイトルです。
        </h2>
        <div class="article_info">
          <p class="_date">2022.4.1</p>
          <p class="_tag">その他</p>
        </div>
        
        <div class="article_container">
          <div class="article_img">
            <img src="../img/topics_sample.jpg" alt="サムネイル">
          </div>
          <p class="article_txt">
            NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。<br>
            <br>
            NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。NEWS記事の本文です。
          </p>
        </div>
        <nav class="pagenation">
          <ul class="pagenation_container">
            <a href="">
              <li class="_prev">&lt;　PREV</li>
            </a>
            <a href="topics.html">
              <li class="_home">TOPICS INDEX</li>
            </a>
            <a href="">
              <li class="_next">MEXT　&gt;</li>
            </a>
          </ul>
        </nav>
      </div>
